...
{
	int index;
	int number1 = 134527, place = 3	; //input for targil 1
	int arr2[] = { 1,3,4,6,9 }, size2 = 5, num2 = 12; //input for Targil 2
	...
	char c6 = 'V'; int buttomLine6 = 19; //Input for Targil 6
	...
	do
	{
		...
		{
			//Q1
			case 1: printf("%d", findDigit(number1, place)); break;

			//Q2
			case 2:
				if (isSum(arr2, size2, num2))
					printf("true");
				else
					printf("false");
				break;
